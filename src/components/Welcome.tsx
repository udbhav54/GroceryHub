...
function Welcome({nextStep}:propType) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 from-green-100 to-white">
      <motion.div
        initial={{
          opacity: 0,
          y: -10,
      ...
      >
        ...
        >
          Your one-stop destination for fresh groceries, organic produce, and daily essentials delivered straight to your doorstep.
        </motion.p>
        ...
        <motion.div
          ...
          className='flex items-centr justify-center gap-10 mt-10'
          >
            <ShoppingBasket className='w-20 h-24 md:w-32 md:h-32 text-green-600'/>

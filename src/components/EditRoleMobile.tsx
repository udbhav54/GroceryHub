...
function EditRoleMobile() {
  ...
  // handel api call to update role and mobile number
  const handelEdit = async () => {
    try {
      const result = await axios.post("/api/user/edit-rolde-mobile", {
  ...
  return (
    <div className="flex flex-col min-h-screen items-center p-6 w-full from-green-50">
      <motion.h1
